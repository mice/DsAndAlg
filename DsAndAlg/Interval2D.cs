...
namespace DsAndAlg
{
    ...
    public class Interval2D<Key> where Key:IComparable<Key>, IEquatable<Key>
    { 
        public Interval<Key> intervalX { get; private set; }   // x-interval
        public Interval<Key> intervalY { get; private set; }   // y-interval

...
public class RangeSearch<Key, Value> 
    ...
    where Value: struct
{
    ...
    ***************************************************************************/
    ...
    private System.Nullable<Value> get(Node x, Key key) {
    ...
    ***************************************************************************/
    ...
    public IEnumerable<Key> range(Key min, Key max) {
        return range(new Interval<Key>(min, max));
    }
    public IEnumerable<Key> range(Interval<Key> interval) { 
    ...
    ***************************************************************************/
    ...
    private boolean isBST() {
        var _min = min();
        var _max = max();
        return _min.HasValue && _max.HasValue&&isBST(root, _min.Value, _max.Value);
    }
